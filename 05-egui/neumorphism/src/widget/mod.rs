...
impl LeftPreview {
    ...
    fn draw_quater_circle(ui: &mut Ui, center: Pos2, direction: widget::Direction, fill: bool) {
        ...
        let stroke = Stroke::new(2., crate::TEXT_OPACITY_COLOR);
        let fill = if fill {
            Color32::YELLOW
        } else {
            Color32::TRANSPARENT
    ...
    pub fn add_quarter_circle(center: Pos2, direction: widget::Direction, ui: &mut Ui) {
        ...
        let rect = Rect::from_min_size(start, [Self::CIRCLE_RADIUS, Self::CIRCLE_RADIUS].into());
