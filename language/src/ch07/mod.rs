...
1. [泛型参数](./ch07_01_generics/fn.f01_01_generics.html)
2. [const泛型](./ch07_01_generics/fn.f01_02_const_generics.html)
...
1. [特征定义和实现](./ch07_02_trait/fn.f02_01_trait.html)
2. [使用特征](./ch07_02_trait/fn.f02_02_use_trait.html)

## 深入特征

1. [关联类型](./ch07_03_advance_trait/fn.f03_01_type.html)
2. [调用同名方法](./ch07_03_advance_trait/fn.f03_02_same_name.html)
3. 特征约束特征
...
mod tests {
    ...
    #[test]
    fn ch07_01() {
        assert_eq!(ch07_01_generics::f01_01_generics(), ());
        assert_eq!(ch07_01_generics::f01_02_const_generics(), ());
    }

    #[test]
    fn ch07_02() {
        assert_eq!(ch07_02_trait::f02_01_trait(), ());
        assert_eq!(ch07_02_trait::f02_02_use_trait(), ());
    }

    #[test]
    fn ch07_03() {
        assert_eq!(ch07_03_advance_trait::f03_01_type(), ());
        assert_eq!(ch07_03_advance_trait::f03_02_same_name(), ());
    }
}
